...
export const HomeIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a1.5 1.5 0 012.122 0l8.954 8.955M3 13.5V21.75A2.25 2.25 0 005.25 24h13.5A2.25 2.25 0 0021 21.75V13.5M10.5 24V16.5a1.5 1.5 0 011.5-1.5h0a1.5 1.5 0 011.5 1.5V24" />
  </svg>
);

export const UsersIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21C7.17 21 5.813 20.617 4.75 19.957M15 19.128c-.305-.142-.612-.294-.923-.451M8.624 21a9.337 9.337 0 01-4.121-.952 4.125 4.125 0 01-3.498-3.589c0-2.095.867-3.992 2.288-5.323M8.624 21a12.318 12.318 0 004.121 2.502M8.624 21L8.622 21M8.624 21l-.002.002M12 9.75a3 3 0 11-6 0 3 3 0 016 0zM12 9.75L12 9.75M12 9.75L12 9.75M15 11.25a3 3 0 11-6 0 3 3 0 016 0z" />
  </svg>
);
...
export const WrenchScrewdriverIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5M11.25 4.5L13.5 3M11.25 4.5L9 6.75M11.25 19.5l7.5-7.5-7.5-7.5M11.25 19.5L13.5 21M11.25 19.5L9 17.25M6 13.875c0-.91.13-1.804.38-2.651M6 13.875c0 .91.13 1.804.38 2.651M6.38 11.224A10.457 10.457 0 006 13.875m.38-2.651A10.457 10.457 0 016 13.875m0 0c0 .91-.13 1.804-.38 2.651M6.38 16.526A10.457 10.457 0 016 13.875m0 0c0-.91.13-1.804.38-2.651M3.75 9.75h16.5M3.75 14.25h16.5" />
  </svg>
);

export const DocumentTextIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h4.5m-4.5 3h9M5.625 17.25H4.125M5.625 3H4.125M19.875 3L19.875 17.25M3.375 3h17.25c.621 0 1.125.504 1.125 1.125v17.25c0 .621-.504 1.125-1.125 1.125H3.375c-.621 0-1.125-.504-1.125-1.125V4.125c0-.621.504-1.125 1.125-1.125z" />
  </svg>
);
...
// --- ÍCONES NOVOS E CORRIGIDOS ABAIXO ---
